        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                <button
                  ...
                  className="hidden sm:flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-200"
                >
                ...
                {langDropdownOpen && (
                  <div className="absolute left-0 mt-2 w-36 rounded-2xl glass-card shadow-xl py-2 border border-slate-200 dark:border-slate-800 z-50 animate-in fade-in slide-in-from-top-2 text-xs font-bold">
                    {[
                      ...
                      <button
                        ...
                        className={`w-full text-left px-3.5 py-2 hover:bg-emerald-50 dark:hover:bg-slate-800 ${
                          lang === l.code ? 'text-emerald-600 font-black' : 'text-slate-700 dark:text-slate-300'
                        }`}
                      >
                        {l.label}
                      </button>
              ...
              <Link
                to="/impact"
                className="hidden xl:flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300 text-[11px] font-bold border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 transition-all shadow-xs"
              >
                <BarChart3 className="w-3.5 h-3.5 text-emerald-600" />
                <span>{t.impact || "Impact Stats"}</span>
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              <Link to="/community" className="px-3 py-2 text-xs font-bold text-teal-600 dark:text-teal-400 hover:underline flex items-center space-x-1">
